...
PARAMS = {
    ...
    "TWIST": {
        "default": 3.0, "min": 0.5, "max": 8.0, "step": 0.1,
        "modulatable": True
    },
    "COLOR_CYCLE": {
    ...
    def render(self, lfo_signals=None):
        ...
        for key in PARAMS:
            ...
            if meta.get("modulatable") and meta.get("mod_active"):
                ...
                elif key == "SYMMETRY": symmetry = int(mod)
        ...
        for y in range(h):
            for x in range(w):
                ...
                # Caleido1: basic kaleidoscopic pattern with symmetry and twist
                angle = theta * symmetry + phase
                v = (math.sin(angle + r * twist) + 1) / 2
                v = v ** 1.8  # contrast
